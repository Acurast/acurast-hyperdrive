...
def test_encoder():
    ...
    scenario.verify(sp.build_lambda(Encoder.encode_uint)(0) == sp.bytes("0x80"))
    scenario.verify(sp.build_lambda(Encoder.encode_uint)(999999999999999) == sp.bytes("0x87038d7ea4c67fff"))
